...
from app.models.api import AoiCreateRequest, AoiResponse, StudyCreateRequest, StudyResponse, TaskCreateRequest, TaskResponse
...
def create_study(payload: StudyCreateRequest) -> StudyResponse:
    record = get_repository().create_study(title=payload.name, description=payload.objective)
