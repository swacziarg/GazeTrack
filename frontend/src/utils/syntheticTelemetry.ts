...
export function generateMockStudyEvents(mode: SyntheticTelemetryMode = 'healthy'): MockStudyEvent[] {
  let eventIndex = 1
  const events: MockStudyEvent[] = [
...
export function countCalibrationEvents(events: MockStudyEvent[]) {
